...
public class PsychologyAttendance extends JFrame {
	MyConnectionClass m;
	JTable tab;
	JScrollPane jsp;
	String rows[]= {"S. No.","Student Name","Student ID","Total Attendance"};
	String d[][];
	PsychologyAttendance()
	{
		super("STUDENT MANAGEMENT SYSTEM- Pshychology Attendance");
