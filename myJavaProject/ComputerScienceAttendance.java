...
public class ComputerScienceAttendance extends JFrame {
	MyConnectionClass m;
	JTable tab;
	JScrollPane jsp;
	String rows[]= {"S. No.","Student Name","Student ID","Total Attendance"};
	String d[][];
	ComputerScienceAttendance()
	{
		super("STUDENT MANAGEMENT SYSTEM- Computer Science Attendance");
	...
	void getData()
	{
		...
		try
		{
			...
			while(rs.next())
			{
				...
				if(temp.equals("Computer Science 102"))
				{
					temp="";
				temp+=sno;
					d[i][j++]=temp;
