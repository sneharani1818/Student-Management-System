...
public class BioMedicalScienceAttendance extends JFrame {
	MyConnectionClass m;
	JTable tab;
	JScrollPane jsp;
	String rows[]= {"S. No.","Student Name","Student ID","Total Attendance"};
	String d[][];
	BioMedicalScienceAttendance()
	{
		super("STUDENT MANAGEMENT SYSTEM- BioMedical Science Attendance");
	...
	void getData()
	{
		...
		try
		{
			...
			while(rs.next())
			{
				...
				if(temp.equals("BioMedical Science 109"))
				{
					temp="";
				temp+=sno;
					d[i][j++]=temp;
